...
//     if (grid_text == NULL || strlen(grid_text) == 0 || word == NULL ||
//     strlen(word) == 0)
//     {
//         return;
//     }
...
//     gtk_text_buffer_set_text(buffer, found ? "Word found !" : "Word not found
//     ", -1);
...
void create_solver_window(GtkWidget *widget, gpointer data)
{
  ...
  // //  G_CALLBACK(on_solve_button_clicked), widgets);
